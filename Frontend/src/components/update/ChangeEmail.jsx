...
function ChangeEmail() {
    ...
    const onSubmit = (data) => {
        ...
        axios.patch("/api/blogs/v1/users/changeEmail", {
        ...
        <>
            <div className='w-[100%] h-[80vh] flex justify-center items-center'>
                <div className='h-fit w-fit flex flex-col items-center gap-4 '>
                    <h1 className='font-semibold text-2xl text-blue-600 '>Change Email</h1>
                    <form
                        ...
                        <label className="input input-bordered flex items-center gap-2">
                            ...
                            <input type="email" className="grow" placeholder="Curr Email"
                                {...register("oldEmail", { required: true })}
                            />
                        </label>
                        {errors.oldemail && <span className='text-[16px] text-red-700'>**This field is required**</span>}
                        <label className="input input-bordered flex items-center gap-2">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 16 16"
                            ...
                            <input type="email" className="grow" placeholder="New Email"
                                {...register("newEmail", { required: true })}
                            />
                        </label>
                        {errors.newEmail && <span className='text-[16px] text-red-700'>**This field is required**</span>}
